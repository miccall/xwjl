...
namespace FluffyUnderware.CurvyEditor.Legacy
{
    ...
    public class CurvySplinePathMeshBuilderInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(new GUIContent("Force Mesh Refresh"), GUILayout.ExpandWidth(false)))
                refresh = true;
            ...
            if (GUILayout.Button(new GUIContent("Save mesh as asset"), GUILayout.ExpandWidth(false)))
                SaveMesh();
