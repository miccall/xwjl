...
namespace FluffyUnderware.DevTools
{
    ...
    public class ActionAttribute : DTAttribute
    {
        ...
        public void Callback(object classInstance)
        {
            ...
            {
                if (mCallback == null)
                    mCallback = classInstance.GetType().GetMethodIncludingBaseClasses(methodName, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
                if (mCallback != null)
        ...
        bool evaluate(Condition cond, object classInstance)
        {
            if (!string.IsNullOrEmpty(cond.MethodName))
            {
                if (cond.MethodInfo == null)
                    cond.MethodInfo = classInstance.GetType().GetMethodIncludingBaseClasses(cond.MethodName, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
                if (cond.MethodInfo != null)
                {
            ...
            else
            {
                ...
                {
                    cond.FieldInfo = classInstance.GetType().GetFieldIncludingBaseClasses(cond.FieldName, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
                    if (cond.FieldInfo == null)
                    {
                        cond.PropertyInfo = classInstance.GetType().GetPropertyIncludingBaseClasses(cond.FieldName, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
                    }
                }
                object value=null;
                if (cond.FieldInfo != null)
